...
<div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between mt-7 px-4 md:px-9 gap-8">
  <div id="1" className="mt-7 text-secondary text-[17px] max-w-3xl leading-[30px] w-full text-center md:text-left">
  ...
  <div className="w-full flex justify-center">
    <div className="w-full max-w-[90vw] sm:max-w-xs md:max-w-[400px] md:mr-16 md:mb-16 mb-2 mx-auto">
      <TiltedCard
        className="pb-18"
        imageSrc={image}
        altText="Ayush"
        containerHeight="min(70vw,300px)"
        containerWidth="min(90vw,300px)"
        imageHeight="min(70vw,300px)"
        imageWidth="min(90vw,300px)"
        rotateAmplitude={12}
        scaleOnHover={1.2}
